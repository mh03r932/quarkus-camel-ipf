 ...
 */
@ApplicationScoped
public class IHEWebServiceClient {
    ...
    public Response iti41ProvideAndRegister(ProvideAndRegisterDocumentSet documentSet, String host, int port,
            String pathAndParameters) throws Exception {
        var endpoint = String.format("xds-iti41://%s:%d/%s", host, port, pathAndParameters);
        return send(endpoint, documentSet, Response.class);
    }

    public RetrievedDocumentSet iti43RetrieveDocumentSet(RetrieveDocumentSet retrieve, String host, int port,
            String pathAndParameters) throws Exception {
    ...
    // =======================
    //
    //    public String iti44PatientFeed(String message, String host, int port, String pathAndParameters, boolean validate)
    //            throws Exception {
    //        if (validate) {
    ...
    //    }
    //
    //    public String iti45PatientQuery(String message, String host, int port, String pathAndParameters, boolean validate)
    //            throws Exception {
    //        if (validate) {
    ...
    //    }
    //
    //    public String iti47PatientDemographicsQuery(String message, String host, int port, String pathAndParameters,
